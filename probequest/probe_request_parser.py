    ...
    def parse(packet):
        ...
        try:
            if packet.haslayer(Dot11ProbeReq):
                ...
                signal = packet.getlayer(RadioTap).dBm_AntSignal
                frequency = packet.getlayer(RadioTap).ChannelFrequency

                return ProbeRequest(timestamp, s_mac, essid, signal, frequency)
